...
for i in range(8, 9):
    ...
    num_t = page.ele('xpath://*[@id="body"]/div/div/div[1]/div[2]/div[4]/div/a[1]/div/p/span').text
    num = int(re.findall(r'\d+', num_t)[0])

    c_url = page.url
    document.add_heading('单选题', level=1)
    page.ele('xpath://*[@id="body"]/div/div/div[1]/div[2]/div[4]/div/a[1]').click()
    ...
    num_t2 = page.ele('xpath://*[@id="body"]/div/div/div[1]/div[2]/div[4]/div/a[2]/div/p/span').text
    num2 = int(re.findall(r'\d+', num_t2)[0])

    page.ele('xpath://*[@id="body"]/div/div/div[1]/div[2]/div[4]/div/a[2]').click()
    page.wait.eles_loaded('xpath://*[@id="body"]/div/div[1]/div[2]/div[1]/div[2]/div[1]/div/div[1]/b/text()')
    beit = page.ele('xpath://*[@id="body"]/div/div[1]/div[2]/div[2]/div[3]/p[2]/span[2]/div')
    if 'is-checked' not in beit.attrs['class']:
        page.ele('xpath://*[@id="body"]/div/div[1]/div[2]/div[2]/div[3]/p[2]/span[2]/div/span').click()
    ...
    num_t3 = page.ele('xpath://*[@id="body"]/div/div/div[1]/div[2]/div[4]/div/a[3]/div/p/span').text
    num3 = int(re.findall(r'\d+', num_t3)[0])

    page.ele('xpath://*[@id="body"]/div/div/div[1]/div[2]/div[4]/div/a[3]').click()
    page.wait.eles_loaded('xpath://*[@id="body"]/div/div[1]/div[2]/div[1]/div[2]/div[1]/div/div[1]/b/text()')
    beit = page.ele('xpath://*[@id="body"]/div/div[1]/div[2]/div[2]/div[3]/p[2]/span[2]/div')
    if 'is-checked' not in beit.attrs['class']:
        page.ele('xpath://*[@id="body"]/div/div[1]/div[2]/div[2]/div[3]/p[2]/span[2]/div/span').click()
